...
(() => {
  ...
  function createSnapLogger(
    prefix = "[snapDOM]",
    { ttlMs = 5 * 6e4, maxEntries = 12 } = {},
  ) {
  ...
  var snapLogger = createSnapLogger("[snapDOM]", {
    ttlMs: 3 * 6e4,
    maxEntries: 10,
  });
    ...
    try {
      const baseHref =
        typeof location !== "undefined" && location.href
          ? location.href
          : "http://localhost/";
      const proxyBaseRaw = useProxy.includes("{url}")
        ? useProxy.split("{url}")[0]
        : useProxy;
  ...
  function snapFetch(_0) {
    return __async(this, arguments, function* (url, options = {}) {
      ...
      const finalURL = shouldProxy(url, useProxy)
        ? applyProxy(url, useProxy)
        : url;
      ...
      if (!cred) {
        try {
          ...
          const u = new URL(url, base);
          const sameOrigin =
            typeof location !== "undefined" && u.origin === location.origin;
      ...
      const p = (() =>
        __async(null, null, function* () {
          var _a2, _b2;
          try {
            const resp = yield fetch(finalURL, {
              signal: ctrl.signal,
              credentials: cred,
              headers,
            });
  ...
  function inlineSingleBackgroundEntry(_0) {
    return __async(this, arguments, function* (entry, options = {}) {
      const isGradient =
        /^((repeating-)?(linear|radial|conic)-gradient)\(/i.test(entry);
      ...
      try {
        const dataUrl = yield snapFetch(encodedUrl, {
          as: "dataURL",
  ...
  function collectUsedTagNames(root) {
    ...
    if (typeof root.querySelectorAll === "function") {
      root
        .querySelectorAll("*")
        .forEach((el) => tagSet.add(el.tagName.toLowerCase()));
    }
...
`;
  ...
  function setupInvalidationOnce(root = document.documentElement) {
    ...
    try {
      ...
      if (f) {
        (_a = f.addEventListener) == null
          ? void 0
          : _a.call(f, "loadingdone", bumpEpoch);
        (_b = f.ready) == null
          ? void 0
          : _b.then(() => bumpEpoch()).catch(() => {});
      }
    } catch (e) {}
  }
  ...
  function _resolveCtx(sessionOrCtx, opts) {
    if (sessionOrCtx && sessionOrCtx.session && sessionOrCtx.persist)
      return sessionOrCtx;
    if (
      sessionOrCtx &&
      (sessionOrCtx.styleMap || sessionOrCtx.styleCache || sessionOrCtx.nodeMap)
    ) {
      return {
  ...
  function inlineAllStyles(source, clone, sessionOrCtx, opts) {
    return __async(this, null, function* () {
      ...
      if (
        NO_DEFAULTS_TAGS.has(
          (_a = source.tagName) == null ? void 0 : _a.toLowerCase(),
        )
      ) {
        const author =
          (_b = source.getAttribute) == null
            ? void 0
            : _b.call(source, "style");
      ...
      if (!key) {
        const tag =
          ((_c = source.tagName) == null ? void 0 : _c.toLowerCase()) || "div";
...
`;
  ...
  function markSlottedSubtree(root) {
    ...
    if (root.querySelectorAll) {
      root
        .querySelectorAll("*")
        .forEach((el) => el.setAttribute("data-sd-slotted", ""));
    }
  }
      ...
      const probe = () => {
        ...
        try {
          return (
            ...
            ((_a = iframe.contentWindow) == null ? void 0 : _a.document) ||
            null
          );
        } catch (e) {
          return null;
  ...
  function deepClone(node, sessionCache, options) {
    return __async(this, null, function* () {
      ...
      if (node.nodeType === Node.ELEMENT_NODE) {
        ...
        if (
          node.id === "snapdom-sandbox" ||
          node.hasAttribute("data-snapdom-sandbox")
        ) {
          return null;
        }
      ...
      if (options.exclude && Array.isArray(options.exclude)) {
        for (const selector of options.exclude) {
          try {
            if (
              (_a = node.matches) == null ? void 0 : _a.call(node, selector)
            ) {
              if (options.excludeMode === "hide") {
                const spacer = document.createElement("div");
                const rect = node.getBoundingClientRect();
            ...
            console.warn(
              `Invalid selector in exclude option: ${selector}`,
              err,
            );
          }
        }
      ...
      if (node.tagName === "IFRAME") {
        ...
        try {
          sameOrigin = !!(
            ...
            ((_b = node.contentWindow) == null ? void 0 : _b.document)
          );
        } catch (e) {
          sameOrigin = false;
        }
      ...
      if (node.getAttribute("data-capture") === "placeholder") {
        ...
        placeholder.textContent =
          node.getAttribute("data-placeholder-text") || "";
      ...
      if (node.shadowRoot) {
        ...
        try {
          ...
          for (const s of slots) {
            ...
            try {
              assigned =
                ((_c = s.assignedNodes) == null
                  ? void 0
                  : _c.call(s, { flatten: true })) ||
                ((_d = s.assignedNodes) == null ? void 0 : _d.call(s)) ||
                [];
            } catch (e) {
              assigned =
                ((_e = s.assignedNodes) == null ? void 0 : _e.call(s)) || [];
            }
        ...
        const cloneList2 = yield idleCallback(
      ...
      if (node.tagName === "SLOT") {
        ...
        const assigned =
          ((_f = node.assignedNodes) == null
            ? void 0
            : _f.call(node, { flatten: true })) || [];
        const nodesToClone =
      ...
      const cloneList = yield idleCallback(
  ...
  function normStyle(s) {
    const t = String(s != null ? s : "normal")
      .trim()
      .toLowerCase();
  ...
  function embedCustomFonts() {
    return __async(
      ...
      function* ({
        ...
        if (!(usedCodepoints instanceof Set))
          usedCodepoints = /* @__PURE__ */ new Set();
        ...
        function faceMatchesRequired(fam, styleSpec, weightSpec, stretchSpec) {
          ...
          const styleOK = (reqKind) =>
            ...
            (ss.kind !== "normal" &&
              (reqKind === "italic" || reqKind === "oblique"));
          let exactMatched = false;
          for (const r of need) {
            const wOk = faceIsRange
              ? r.w >= ws.min && r.w <= ws.max
              : r.w === faceSingleW;
        ...
        function subsetFromRanges(ranges) {
          ...
          const viet =
            hit(7840, 7929) || hit(258, 259) || hit(416, 417) || hit(431, 432);
        ...
        function buildSimpleExcluder(ex = {}) {
          const famSet = new Set(
            (ex.families || []).map((s) => String(s).toLowerCase()),
          );
          const domSet = new Set(
            (ex.domains || []).map((s) => String(s).toLowerCase()),
          );
          const subSet = new Set(
            (ex.subsets || []).map((s) => String(s).toLowerCase()),
          );
          return (meta, parsedRanges) => {
            if (famSet.size && famSet.has(meta.family.toLowerCase()))
              return true;
            if (domSet.size) {
        ...
        function dedupeFontFaces(cssText) {
          ...
          for (const block of cssText.match(FACE_RE2) || []) {
            const familyRaw =
              ((_a2 = block.match(/font-family:\s*([^;]+);/i)) == null
                ? void 0
                : _a2[1]) || "";
            const family = pickPrimaryFamily(familyRaw);
            const weightSpec = (
              ((_b2 = block.match(/font-weight:\s*([^;]+);/i)) == null
                ? void 0
                : _b2[1]) || "400"
            ).trim();
            const styleSpec = (
              ((_c2 = block.match(/font-style:\s*([^;]+);/i)) == null
                ? void 0
                : _c2[1]) || "normal"
            ).trim();
            const stretchSpec = (
              ((_d2 = block.match(/font-stretch:\s*([^;]+);/i)) == null
                ? void 0
                : _d2[1]) || "100%"
            ).trim();
            const urange = (
              ((_e2 = block.match(/unicode-range:\s*([^;]+);/i)) == null
                ? void 0
                : _e2[1]) || ""
            ).trim();
            const srcRaw = (
              ((_f2 = block.match(/src\s*:\s*([^;]+);/i)) == null
                ? void 0
                : _f2[1]) || ""
            ).trim();
        ...
        function buildFontsCacheKey() {
          ...
          const ex = exclude
            ? JSON.stringify({
                families: (exclude.families || [])
                  .map((s) => String(s).toLowerCase())
                  .sort(),
                domains: (exclude.domains || [])
                  .map((s) => String(s).toLowerCase())
                  .sort(),
                subsets: (exclude.subsets || [])
                  .map((s) => String(s).toLowerCase())
                  .sort(),
              })
            : "";
        ...
        for (const link of linkNodes) {
          try {
            ...
            if (!sameOrigin) {
              if (!isLikelyFontStylesheet(link.href, requiredFamilies))
                continue;
            }
            if (sameOrigin) {
            ...
            for (const face of cssText.match(FACE_RE) || []) {
              const famRaw = (
                ((_b = face.match(/font-family:\s*([^;]+);/i)) == null
                  ? void 0
                  : _b[1]) || ""
              ).trim();
              ...
              const weightSpec = (
                ((_c = face.match(/font-weight:\s*([^;]+);/i)) == null
                  ? void 0
                  : _c[1]) || "400"
              ).trim();
              const styleSpec = (
                ((_d = face.match(/font-style:\s*([^;]+);/i)) == null
                  ? void 0
                  : _d[1]) || "normal"
              ).trim();
              const stretchSpec = (
                ((_e = face.match(/font-stretch:\s*([^;]+);/i)) == null
                  ? void 0
                  : _e[1]) || "100%"
              ).trim();
              const urange = (
                ((_f = face.match(/unicode-range:\s*([^;]+);/i)) == null
                  ? void 0
                  : _f[1]) || ""
              ).trim();
              const srcRaw = (
                ((_g = face.match(/src\s*:\s*([^;]+);/i)) == null
                  ? void 0
                  : _g[1]) || ""
              ).trim();
              const srcUrls = extractSrcUrls(srcRaw, link.href);
              if (
                !faceMatchesRequired(family, styleSpec, weightSpec, stretchSpec)
              ) {
                continue;
              }
              ...
              const newFace = /url\(/i.test(srcRaw)
                ? yield inlineUrlsInCssBlock(face, link.href)
                : face;
              facesOut += newFace + "";
            }
        ...
        for (const sheet of document.styleSheets) {
          try {
            if (sheet.href && linkNodes.some((l) => l.href === sheet.href))
              continue;
            const rules = sheet.cssRules || [];
            for (const rule of rules) {
              ...
              if (/url\(/i.test(srcRaw)) {
                const inlinedSrc = yield inlineUrlsInCssBlock(
                  srcRaw,
                  sheet.href || location.href,
                );
        ...
        try {
          for (const f of document.fonts || []) {
            ...
            if (
              (exclude == null ? void 0 : exclude.families) &&
              exclude.families.some(
                (n) => String(n).toLowerCase() === fam.toLowerCase(),
              )
            ) {
              continue;
            }
            ...
            if (!String(b64).startsWith("data:")) {
              if (
                (_h = cache.resource) == null ? void 0 : _h.has(f._snapdomSrc)
              ) {
                b64 = cache.resource.get(f._snapdomSrc);
                (_i = cache.font) == null ? void 0 : _i.add(f._snapdomSrc);
              } else if (
                !((_j = cache.font) == null ? void 0 : _j.has(f._snapdomSrc))
              ) {
                try {
                  const r = yield snapFetch(f._snapdomSrc, {
                    as: "dataURL",
                    useProxy,
                    silent: true,
                  });
                  if (r.ok && typeof r.data === "string") {
                    b64 = r.data;
                    (_k = cache.resource) == null
                      ? void 0
                      : _k.set(f._snapdomSrc, b64);
        ...
        for (const font of localFonts) {
          ...
          const family = String(font.family || "").replace(
            /^['"]+|['"]+$/g,
            "",
          );
          if (!family || isIconFont2(family)) continue;
          ...
          if (
            (exclude == null ? void 0 : exclude.families) &&
            exclude.families.some(
              (n) => String(n).toLowerCase() === family.toLowerCase(),
            )
          )
            continue;
          ...
          const stretch =
            font.stretchPct != null ? `${font.stretchPct}%` : "100%";
  ...
  function buildCounterContext(root) {
    ...
    const countPrevLi = (li) => {
      let c = 0,
        p = li == null ? void 0 : li.parentElement;
      if (!p) return 0;
    ...
    const applyTo = (baseMap, parentMap, el) => {
      ...
      try {
        reset =
          ((_a = el.style) == null ? void 0 : _a.counterReset) ||
      ...
      try {
        inc =
          ((_b = el.style) == null ? void 0 : _b.counterIncrement) ||
          getComputedStyle(el).counterIncrement;
      } catch (e) {}
      if (inc && inc !== "none") {
      ...
      try {
        ...
        if (cs.display === "list-item" && isLi(el)) {
          ...
          if (p && p.tagName === "OL") {
            ...
            const start = Number.isFinite(Number(startAttr))
              ? Number(startAttr)
              : 1;
            const prev = countPrevLi(el);
            const ownAttr = el.getAttribute("value");
            idx = Number.isFinite(Number(ownAttr))
              ? Number(ownAttr)
              : start + prev;
          } else {
  ...
  function deriveCounterCtxForPseudo(node, pseudoStyle, baseCtx) {
    ...
    const resets = parseListDecl(
      pseudoStyle == null ? void 0 : pseudoStyle.counterReset,
    );
    const incs = parseListDecl(
      pseudoStyle == null ? void 0 : pseudoStyle.counterIncrement,
    );
      ...
      for (const pseudo of ["::before", "::after", "::first-letter"]) {
        try {
          ...
          if (pseudo === "::first-letter") {
            ...
            const textNode = Array.from(clone.childNodes).find((n) => {
              var _a2;
              return (
                n.nodeType === Node.TEXT_NODE &&
                ((_a2 = n.textContent) == null ? void 0 : _a2.trim().length) > 0
              );
            });
            ...
            const rest = text.slice(
              (first == null ? void 0 : first.length) || 0,
            );
          ...
          const { text: cleanContent, incs } = resolvePseudoContentAndIncs(
            source,
            pseudo,
            counterCtx,
          );
          ...
          const hasExplicitContent =
            rawContent !== "none" && cleanContent !== "";
          const hasBg = bg && bg !== "none";
          const hasBgColor =
            bgColor &&
            bgColor !== "transparent" &&
            bgColor !== "rgba(0, 0, 0, 0)";
          const hasBox2 = display !== "inline" && (width > 0 || height > 0);
          const hasBorder =
          ...
          if (!shouldRender) {
            if (incs && incs.length && source.parentElement) {
              const map =
                __siblingCounters.get(source.parentElement) ||
                /* @__PURE__ */ new Map();
              for (const { name, num } of incs) {
                ...
                const derived = deriveCounterCtxForPseudo(
                  source,
                  getComputedStyle(source, pseudo),
                  baseWithSibs,
                );
          ...
          if (isIconFont22 && cleanContent && cleanContent.length === 1) {
            ...
            if (rawUrl == null ? void 0 : rawUrl.trim()) {
              try {
                const imgEl = document.createElement("img");
                const dataUrl = yield snapFetch(safeEncodeURI(rawUrl), {
                  as: "dataURL",
                  useProxy: options.useProxy,
                });
          ...
          if (hasBg) {
            try {
              ...
              const newBgParts = yield Promise.all(
                bgSplits.map(inlineSingleBackgroundEntry),
              );
              pseudoEl.style.backgroundImage = newBgParts.join(", ");
            } catch (e) {
              console.warn(
                `[snapdom] Failed to inline background-image for ${pseudo}`,
                e,
              );
            }
          }
          ...
          const hasContent2 =
            ...
            ((_a = pseudoEl.textContent) == null ? void 0 : _a.trim()) !== "";
          const hasVisibleBox =
  ...
  function inlineExternalDefsAndSymbols(rootElement) {
    ...
    const globalSymbols = allGlobal.filter(
      (el) => el.tagName.toLowerCase() === "symbol",
    );
    const globalDefs = allGlobal.filter(
    ...
    while (walker.nextNode()) {
      ...
      const topAbsPx =
        topInit != null
          ? topInit + scrollTop
          : scrollTop +
            (viewportH - heightPx /** bottomInit non-null */ - bottomInit);
      ...
      (_a = cloneEl.parentElement) == null
        ? void 0
        : _a.insertBefore(ph, cloneEl);
  ...
  function prepareClone(_0) {
    return __async(this, arguments, function* (element, options = {}) {
      ...
      for (const [node, key] of sessionCache.styleMap.entries()) {
        ...
        const hasIcon =
          (_b = node.dataset) == null ? void 0 : _b.snapdomHasIcon;
      ...
      if (element === sessionCache.nodeMap.get(clone)) {
        const computed =
          sessionCache.styleCache.get(element) ||
  ...
  function stabilizeLayout(element) {
    ...
    const borderAbsent =
      borderStyle === "none" || parseFloat(borderWidth) === 0;
  ...
  function blobUrlToDataUrl(blobUrl) {
    return __async(this, null, function* () {
      var _a;
      if ((_a = cache.resource) == null ? void 0 : _a.has(blobUrl))
        return cache.resource.get(blobUrl);
      if (_blobToDataUrlCache.has(blobUrl))
        return _blobToDataUrlCache.get(blobUrl);
      const p = (() =>
        __async(null, null, function* () {
          var _a2;
  ...
  function resolveBlobUrlsInTree(root) {
    return __async(this, null, function* () {
      ...
      for (const node of svgImages) {
        try {
          ...
          const href =
            ...
            ((_a = node.getAttributeNS) == null
              ? void 0
              : _a.call(node, XLINK_NS, "href"));
          if (isBlobUrl(href)) {
            const d = yield blobUrlToDataUrl(href);
            node.setAttribute("href", d);
            (_b = node.removeAttributeNS) == null
              ? void 0
              : _b.call(node, XLINK_NS, "href");
          }
        } catch (e) {}
      }
      const styled = root.querySelectorAll
        ? root.querySelectorAll("[style*='blob:']")
        : [];
      ...
      const styleTags = root.querySelectorAll
      ...
      for (const attr of urlAttrs) {
        const nodes = root.querySelectorAll
          ? root.querySelectorAll(`[${attr}^='blob:']`)
          : [];
        ...
        __async(null, null, function* () {
          ...
          if (fallbackURL) {
            try {
              const dsW =
                parseInt(
                  ((_a = img.dataset) == null ? void 0 : _a.snapdomWidth) || "",
                  10,
                ) || 0;
              const dsH =
                parseInt(
                  ((_b = img.dataset) == null ? void 0 : _b.snapdomHeight) ||
                    "",
                  10,
                ) || 0;
              ...
              const styleW =
                parseFloat(
                  ((_c = img.style) == null ? void 0 : _c.width) || "",
                ) || 0;
              const styleH =
                parseFloat(
                  ((_d = img.style) == null ? void 0 : _d.height) || "",
                ) || 0;
              ...
              const fallbackUrl =
                typeof fallbackURL === "function"
                  ...
                  : fallbackURL;
              if (fallbackUrl) {
                const fallbackData = yield snapFetch(fallbackUrl, {
                  as: "dataURL",
                  useProxy: options.useProxy,
                });
  ...
  function inlineBackgroundImages(_0, _1, _2) {
    return __async(
      this,
      arguments,
      function* (source, clone, styleCache, options = {}) {
        ...
        while (queue.length) {
          ...
          for (const prop of URL_PROPS) {
            ...
            const inlined = yield Promise.all(
              splits.map((entry) =>
                inlineSingleBackgroundEntry(entry, options),
              ),
            );
            if (
              inlined.some(
          ...
          for (
            let i = 0;
            i < Math.min(sChildren.length, cChildren.length);
            i++
          ) {
  ...
  function captureDOM(element, options) {
    return __async(this, null, function* () {
      ...
      try {
        ({ clone, classCSS, styleCache } = yield prepareClone(
          element,
          options,
        ));
      } finally {
          ...
          () => {
            ...
            function parseFilterDropShadows(cs) {
              ...
              for (const tok of tokens) {
                found = true;
                const nums =
                  ((_a = tok.match(/-?\d+(?:\.\d+)?px/gi)) == null
                    ? void 0
                    : _a.map((v) => parseFloat(v))) || [];
            ...
            function parseBoxShadow(cs) {
              ...
              for (const part of parts) {
                const nums =
                  ((_a = part.match(/-?\d+(\.\d+)?px/g)) == null
                    ? void 0
                    : _a.map((n) => parseFloat(n))) || [];
            ...
            if (hasTFBBox(element)) {
              const baseTransform2 =
                csEl.transform && csEl.transform !== "none"
                  ? csEl.transform
                  : "";
            ...
            const outW = Math.max(
              1,
              Math.round(vbW0 * (hasW || hasH ? w / w0 : 1)),
            );
            const outH = Math.max(
              1,
              Math.round(vbH0 * (hasH || hasW ? h / h0 : 1)),
            );
            ...
            options.meta = {
              ...
              // alto del viewBox
              targetW: w,
              // ancho deseado según options.width
              targetH: h,
              // alto deseado según options.height
            };
  ...
  function readIndividualTransforms(el) {
    ...
    if (map) {
      ...
      if (sc) {
        const sx =
          "x" in sc && ((_a = sc.x) == null ? void 0 : _a.value) != null
            ? sc.x.value
            : Array.isArray(sc)
              ? (_b = sc[0]) == null
                ? void 0
              ...
              : Number(sc) || 1;
        const sy =
          "y" in sc && ((_c = sc.y) == null ? void 0 : _c.value) != null
            ? sc.y.value
            : Array.isArray(sc)
              ? (_d = sc[1]) == null
                ? void 0
      ...
      if (tr) {
        ...
        const ty =
          "y" in tr && "value" in tr.y
            ...
            : Array.isArray(tr)
              ...
              : 0;
        const ux =
          "x" in tr && ((_g = tr.x) == null ? void 0 : _g.unit)
            ? tr.x.unit
            : "px";
        const uy =
          "y" in tr && ((_h = tr.y) == null ? void 0 : _h.unit)
            ? tr.y.unit
            : "px";
        ...
        const cs2 = getComputedStyle(el);
        out.translate =
          cs2.translate && cs2.translate !== "none" ? cs2.translate : null;
      }
      return out;
    }
    const cs = getComputedStyle(el);
    ...
    out.translate =
      cs.translate && cs.translate !== "none" ? cs.translate : null;
    return out;
  }
  function hasBBoxAffectingTransform(el) {
    ...
    const tr =
      cs.translate && cs.translate !== "none" && cs.translate !== "0px 0px";
  ...
  function normalizeCachePolicy(v) {
    if (typeof v === "string") {
      ...
      if (s === "disabled" || s === "full" || s === "auto" || s === "soft")
        return (
          /** @type {CachePolicy} */
          s
        );
  ...
  function createContext(options = {}) {
    ...
    return {
      ...
      iconFonts: Array.isArray(options.iconFonts)
        ? options.iconFonts
        : options.iconFonts
          ? [options.iconFonts]
          : [],
      ...
      backgroundColor:
        (_q = options.backgroundColor) != null
          ? _q
          : ["jpg", "jpeg", "webp"].includes(resolvedFormat)
            ? "#ffffff"
            : null,
  ...
  function boxShadowToDropShadow(value) {
    ...
    for (const layer of layers) {
      ...
      fns.push(
        `drop-shadow(${ox} ${oy} ${blur}${hasColor ? ` ${color}` : ""})`,
      );
    }
    return fns.join(" ");
  }
  ...
  function rewriteCssBlock(css) {
    return css.replace(
      /([^{}]+)\{([^}]*)\}/g,
      (_m, sel, body) => `${sel}{${rewriteDeclList(body)}}`,
    );
  }
  ...
  function toImg(url, options) {
    return __async(this, null, function* () {
      ...
      const wantsScale =
        (Number.isFinite(scale) && scale !== 1) || hasW || hasH;
      if (isSafari() && wantsScale) {
        const pngUrl = yield rasterize(
          url,
    ...
    return __async(this, null, function* () {
      ...
      if (options.format === "svg") {
        const blob = yield toBlob(
          url,
          __spreadProps(__spreadValues({}, options), { type: "svg" }),
        );
  ...
  function snapdom(element, userOptions) {
    return __async(this, null, function* () {
      ...
      if (
        isSafari() &&
        (context.embedFonts === true || hasBackgroundOrMask(element))
      ) {
        for (let i = 0; i < 3; i++) {
          try {
      ...
      if (context.iconFonts && context.iconFonts.length > 0)
  ...
  snapdom.capture = (el, context, _token) =>
    __async(null, null, function* () {
      ...
      const ensureContext = (opts) =>
        __spreadValues(__spreadValues({}, context), opts || {});
      const withFormat = (format) => (opts) => {
        const next = ensureContext(
          __spreadProps(__spreadValues({}, opts || {}), { format }),
        );
  ...
  snapdom.toRaw = (el, options) =>
    snapdom(el, options).then((result) => result.toRaw());
  snapdom.toImg = (el, options) =>
    snapdom(el, options).then((result) => result.toImg());
  snapdom.toCanvas = (el, options) =>
    snapdom(el, options).then((result) => result.toCanvas());
  snapdom.toBlob = (el, options) =>
    snapdom(el, options).then((result) => result.toBlob());
  snapdom.toPng = (el, options) =>
    snapdom(
      el,
      __spreadProps(__spreadValues({}, options), { format: "png" }),
    ).then((result) => result.toPng());
  snapdom.toJpg = (el, options) =>
    snapdom(
      el,
      __spreadProps(__spreadValues({}, options), { format: "jpeg" }),
    ).then((result) => result.toJpg());
  snapdom.toWebp = (el, options) =>
    snapdom(
      el,
      __spreadProps(__spreadValues({}, options), { format: "webp" }),
    ).then((result) => result.toWebp());
  snapdom.download = (el, options) =>
    snapdom(el, options).then((result) => result.download());
  ...
  function preCache() {
    return __async(this, arguments, function* (root = document, options = {}) {
      ...
      const cacheMode =
        (_b = (_a = options.cache) != null ? _a : options.cacheOpt) != null
          ? _b
          : "full";
      ...
      for (const img of imgEls) {
        const src =
          (img == null ? void 0 : img.currentSrc) ||
              ...
              const p = Promise.resolve()
                .then(() =>
                  inlineSingleBackgroundEntry(
                    entry,
                    __spreadProps(__spreadValues({}, options), { useProxy }),
                  ),
                )
                .catch(() => {});
              promises.push(p);
      ...
      if (embedFonts) {
        try {
          ...
          const safari =
            typeof isSafari === "function" ? isSafari() : !!isSafari;
          if (safari) {
            const families = new Set(
              Array.from(required)
                .map((k) => String(k).split("__")[0])
